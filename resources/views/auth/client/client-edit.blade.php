    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('client.edit') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$client->email" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="dateOfBirth" class="block mt-1 w-full"
                                type="date"
                                name="dateOfBirth" value="{{$client->dateOfBirth}}" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-select id="sex" class="block mt-1 w-full"
                                name="sex" :value="$client->sex" :option="['Male','Female']" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="mobileNumber" class="block mt-1 w-full"
                                ...
                                name="mobileNumber" value="{{$client->mobileNumber}}" required />
            </div>
